...
void write_display1()
{
  glColor3f(0.0,0.0,0.0);
    ...
    write_function(-0.22f, 0.6f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Supervised By : MAHFUJUR RAHMAN");
    write_function(-0.18f, 0.50f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, " LECTURER,Computer Science");
    write_function(-0.1f, 0.4f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ARMY CAMP");
    write_function(-0.2f, 0.2f, 0.0f, GLUT_BITMAP_HELVETICA_18, "   Press P for show project");


    write_function(0.5f, -.40f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Develop By :");
    write_function(0.5f, -.50f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    MD TAWHID RAHMAN");
    write_function(0.5f, -.55f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    MD JAHID HASAN KHAN");
    write_function(0.5f, -.60f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    MD SHARIAR SHAON");
    write_function(0.5f, -.65f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    SAYEM SARKER");
    write_function(0.5f, -.70f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    NAFIS MUBASSHIR");
    write_function(0.5f, -.75f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    MAHMUDUR RAHMAN");
...
glutInit(&argc, argv);
    ...
    cout<<"\n  SUBMITTED BY ";
    cout<<"\n             1. MD TAWHID RAHMAN";
    cout<<"\n             2. MD JAHID HASAN KHAN";
    cout<<"\n             3. MD SHAHRIAR SHAON";
    cout<<"\n             4. NAFIS MUBASSHIR SHAH";
    cout<<"\n             5. SAYEM SARKER";
    cout<<"\n             5. MD MAHMUDUR RAHMAN SHUBO";
